...
public class Calendario
{
    ...
    ArrayList listadeReservas = new ArrayList();
    ...
    public void InicializarMeses()
    {
        ...
        {//ejecuta el case correspondiente el cual almacena la cant de dias que tiene ese mes
            switch (i)
            {
                case 0: mes.Add(31); break;//por ejemplo aca case 0 seria mes 1 entonces Add(31) dias a enero
                case 1: mes.Add(28); break;//ojo agrega solo el numero pero no es que agrega esa cant de objetos
                case 2: mes.Add(31); break;
                case 3: mes.Add(30); break;
                case 4: mes.Add(31); break;
                case 5: mes.Add(30); break;
                case 6: mes.Add(31); break;
                case 7: mes.Add(31); break;
                case 8: mes.Add(30); break;
                case 9: mes.Add(31); break;
                case 10: mes.Add(30); break;
                case 11: mes.Add(31); break;
    ...
    {   //cuando llamamos al metodo realizamos una entrada de datos con Console.readline
        ...
        Reserva nuevaReserva = new Reserva(diaElegido, mesElegido);//instanciamos la clase reserva
        //y usamos de parametros los datos ingresados previamente por crl
        listadeReservas.Add(nuevaReserva);
        //el objeto instanciado lo agregamos a la lista de reservas
        cliente.NewReserva(nuevaReserva);//guardamos la reserva en el cliente
    ...
    public void buscarReservasDisponibles()
    {
        ...
        for (int i = 0; i < mes.Count; i++)//Bucle para llenar la lista con numeros del 1 al 12
        {//es decir, los numeros de los meses
            mesPorNum.Add(i + 1);
        }
        foreach (int nroMes in mesPorNum)//foreach para recorrer la lista creada con la cant de meses
        {
            ...
            for (int dia = 1; dia <= cantDias; dia++)//realizamos un for para recorrer los dias que contiene totales de ese mes, por eso < cantDias
            {
                ...
                {
                    if (r.mesReservado == nroMes && r.diaReservado == dia) //Si el mes reservado es igual al numero del mes y el diareservado es igual
